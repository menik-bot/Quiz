...
const checkAnswer = (userAnswer, tag, n) => {
    ...
    if (cA == 0) {
        if (userAnswer == data[n].answer) {
            ...
            userAnswered = true;
            document.getElementById("scoreboard").innerHTML = correctAnswer;
            ...
            nextBtn.style.background = "#F09289";
            userAnswered = true;
            cA++;
        }
    }
